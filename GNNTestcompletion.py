...
# Process text data to extract entities and relationships
text_data = [
    ("Tom likes apples", "like"),
    ("Alice eats oranges", "eat"),
    ("Bob dislikes bananas", "dislike")
]
...
for sentence, relation in text_data:
    head, relation, tail = sentence.split()
